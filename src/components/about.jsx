      ...
      <div>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>Hi, I'm Varshini! I'm a passionate software developer with a love for creating
                    ...
                    of this ever-evolving industry.</p>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>DevOps</h3>
                    <p>I am currently learning DevOps and working with tools like Jenkins, Docker, K8s and Maven</p>
                </div>
                </div>
            </div>
            {/*
